...
Ứng dụng sử dụng thuật toán **Backtracking** để tìm lời giải cho Sudoku.

Để giảm số lần quay lui và tăng tốc độ xử lý, chương trình kết hợp thêm **Heuristic MRV**, giúp ưu tiên chọn ô có ít giá trị hợp lệ nhất trước khi tiếp tục tìm kiếm.
